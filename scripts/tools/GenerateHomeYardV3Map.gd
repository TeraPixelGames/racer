...
func _add_upper_hall_landing_floor(root: Node3D, parent: Node3D) -> void:
	...
	var west_side_infill := _add_box(root, holder, "UpperHallLandingFloorStairwellSideInfillWest", Vector3(50.9, 52.05, 53.0), Vector3(5.8, 1.1, 70.0), Color(0.62, 0.56, 0.47), true)
