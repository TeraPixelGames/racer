...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	assert_true(_grid_road_covers_route(instance.get_node_or_null("BuiltTrack/GridRoad") as GridMap, definition), "Kitchen GridRoad should have one visible tile for every route cell so textures stay aligned with the route")
	assert_true(_grid_road_only_uses_route_cells(instance.get_node_or_null("BuiltTrack/GridRoad") as GridMap, definition), "Kitchen GridRoad should hide painted cells outside the resolved route")
	assert_equal(definition.road_width, 16.0, "Kitchen route collision should match the 16x16 GridMap road footprint")
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Rails") == null, "Kitchen track should not build rail containment")
	assert_true(instance.get_node_or_null("BuiltTrack/BoundaryWalls") != null, "Kitchen track should include generated invisible boundary walls")
	assert_true(_enabled_collision_objects(instance.get_node_or_null("BuiltTrack/BoundaryWalls")) > 0, "Kitchen boundary walls should be collidable")
	assert_equal(_node_count_by_type(instance.get_node_or_null("BuiltTrack/BoundaryWalls"), "MeshInstance3D"), 0, "Kitchen boundary walls should be invisible unless debug rendering is enabled")
	assert_true(instance.get_node_or_null("BuiltTrack/Walls") == null, "Kitchen track should not build legacy route-centerline walls")
	...
	if str(definition.get_meta("track_map_id", "")).begins_with("home_yard"):
		...
		assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/VerticalConnectors/MainStairLowerFlightKenneySteps") == null, "Kitchen shared runtime should not include obsolete split-stair Kenney reference geometry")
		...
		assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/VerticalConnectors/MainStairStraightFlightTread10") != null, "Kitchen shared runtime should include a continuous straight stair flight, not disconnected stair props")
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor") != null, "Editable room scene should include named kitchen task-center decor")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor/PrepCuttingBoard") != null, "Kitchen decor should include a prep landing cutting board")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor/CoffeeStationMachine") != null, "Kitchen decor should include a coffee station appliance")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/PantryDecor") != null, "Editable room scene should include named pantry storage decor")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/PantryDecor/PantryCerealBoxLower") != null, "Pantry decor should include readable shelf goods")
	assert_equal(_enabled_collision_objects(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor")), 0, "Kitchen decor should remain visual-only")
	assert_equal(_enabled_collision_objects(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/PantryDecor")), 0, "Pantry decor should remain visual-only")
	assert_true(_dressing_node_clears_route(instance, "BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor/PrepCuttingBoard", definition, 0.0), "Prep landing decor should stay outside the racing line")
	assert_true(_dressing_node_clears_route(instance, "BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor/CoffeeStationMachine", definition, 0.0), "Coffee station decor should stay outside the racing line")
	assert_true(_dressing_node_clears_route(instance, "BuiltTrack/Dressing/EditableRoom/Track/KitchenDecor/RightCounterBlender", definition, 0.0), "Right counter decor should stay outside the racing line")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/Lighting/CooktopTaskLight") is OmniLight3D, "Kitchen lighting should include a cooktop task light")
...
func test_outdoor_playground_runtime_uses_shared_backyard_gridmap_shell() -> void:
	...
	assert_equal(definition.track_source_id, "road_grid_map", "Outdoor Playground should resolve from RoadGridMap metadata")
	assert_equal(definition.road_visual_style, "kenney_gridmap", "Outdoor Playground should use GridMap road visuals")
	...
	var track_node := built.get("node", null) as Node3D
	scene_tree.root.add_child(track_node)
	assert_true(track_node.get_node_or_null("Road/CollisionBody/CollisionShape3D") != null, "Outdoor Playground should build hidden road collision")
	assert_true(track_node.get_node_or_null("GridRoad") is GridMap, "Outdoor Playground should build visible GridRoad tiles")
	assert_true(track_node.get_node_or_null("BoundaryWalls") != null, "Outdoor Playground should build invisible boundary walls")
	assert_true(track_node.get_node_or_null("Rails") == null, "Outdoor Playground should not build rails")
	assert_true(track_node.get_node_or_null("SpawnPoints/Start01") != null, "Outdoor Playground should build generated spawn points")
	assert_true(track_node.get_node_or_null("SpawnPoints/Start08") != null, "Outdoor Playground should build all eight generated spawn points")
	...
	assert_equal(_mesh_shader_path(track_node, "Dressing/EditableRoom/BackyardShell/floor/MeshInstance3D"), OUTDOOR_GRASS_SHADER, "Outdoor Playground shared backyard floor should use the grass shader at runtime")
	assert_equal(_shader_texture_path(track_node, "Dressing/EditableRoom/BackyardShell/floor/MeshInstance3D", "floor_texture"), OUTDOOR_PLAYGROUND_FLOOR_TEXTURE, "Outdoor Playground shared backyard floor should use the authored floor texture at runtime")
...
func test_attic_mayhem_authoring_scene_contains_gridmap_mvp_assets() -> void:
	...
	var instance := (packed as PackedScene).instantiate()
	scene_tree.root.add_child(instance)
	assert_true(instance.get_node_or_null("floor/MeshInstance3D") != null, "Attic MVP scene should include a visual-only floor")
	assert_true(instance.get_node_or_null("RoomShell/BackWall") != null, "Attic MVP scene should include a rear shell wall")
	...
	assert_true((road_grid_map.get("ordered_route_cells") as Array).size() >= 12 if road_grid_map != null else false, "Attic RoadGridMap should author a closed route")
	assert_true(instance.find_child("TrackAuthoringPreview", true, false) == null, "Attic MVP scene should not include legacy track authoring")
	assert_true(instance.find_child("RoutePoints", true, false) == null, "Attic MVP scene should not include legacy route points")
	assert_true(instance.find_child("RoadSegments", true, false) == null, "Attic MVP scene should not include legacy road segments")
	assert_true(instance.find_child("SpawnPoints", true, false) == null, "Attic MVP scene should not include legacy spawn markers")
	assert_true(instance.find_child("Checkpoints", true, false) == null, "Attic MVP scene should not include legacy checkpoint markers")
	instance.queue_free()
...
func test_attic_mayhem_runtime_builds_redesigned_room() -> void:
	...
	assert_equal(definition.track_source_id, "road_grid_map", "Attic should resolve from RoadGridMap metadata")
	assert_equal(definition.road_visual_style, "kenney_gridmap", "Attic should use GridMap road visuals")
	...
	if str(definition.get_meta("track_map_id", "")).begins_with("home_yard"):
		...
		assert_true(shared_track.get_node_or_null("Dressing/EditableRoom/VerticalConnectors/AtticRearStairKenneyStepsReference") != null, "Runtime attic should include a hidden sourced attic stair reference")
		assert_true(shared_track.get_node_or_null("Dressing/EditableRoom/VerticalConnectors/AtticRearStairLowerLandingSurface") != null, "Runtime attic should include measured lower landing continuity geometry")
		assert_true(shared_track.get_node_or_null("Dressing/EditableRoom/VerticalConnectors/AtticRearStairUpperLandingSurface") != null, "Runtime attic should include measured attic hatch landing continuity geometry")
		assert_true(shared_track.get_node_or_null("Dressing/EditableRoom/VerticalConnectors/AtticRearStairTread13") != null, "Runtime attic should include stair treads spanning to the attic, not ladder rungs or disconnected stair props")
	...
	var track_node := built.get("node", null) as Node3D
	scene_tree.root.add_child(track_node)
	assert_true(track_node.get_node_or_null("Road/CollisionBody/CollisionShape3D") != null, "Runtime attic should include hidden road collision")
	assert_true(track_node.get_node_or_null("GridRoad") is GridMap, "Runtime attic should include visible GridRoad tiles")
	assert_true(track_node.get_node_or_null("BoundaryWalls") != null, "Runtime attic should include invisible boundary walls")
	assert_true(track_node.get_node_or_null("Rails") == null, "Runtime attic should not build rails")
